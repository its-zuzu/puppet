...
function FallingPatternComponent({
  color = 'var(--primary)',
  ...
  const mergedClassName = ['relative h-full w-full p-px', className]
    .filter(Boolean)
    .join(' ');
      ...
      >
        <motion.div
          ...
          variants={{
            ...
            animate: {
              backgroundPosition: prefersReducedMotion ? startPositions : [startPositions, endPositions],
              transition: {
...
export const FallingPattern = memo(FallingPatternComponent);
